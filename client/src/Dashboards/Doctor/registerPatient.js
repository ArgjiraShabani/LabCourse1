    ...
    return (
        ...
        <div style={{display:"flex"}}>
            ...
            <div className="container mt-5">
                ...
                <form  onSubmit={handleClick} className="mt-4" style={{borderRadius:'10px',borderWidth:'1px',borderColor:"white",boxShadow: '0 4px 20px rgba(0, 0, 0, 0.3)',padding:"50px",margin:"50px"}}>
                    <div className="mb-3">
